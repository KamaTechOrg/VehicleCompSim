...
//const std::string VIDEO_DIR = R"(C:\Users\dmaro\Downloads\videos_for_tracking)";
//const std::string VIDEO_PATH = VIDEO_DIR + "\\01c71072-718028b8.mov";
//const std::string VIDEO_PATH = VIDEO_DIR+"\\00b04b30-501822fa.mov";

const std::string VIDEO_DIR = R"(C:\Users\mende\Desktop\Project\Data\DataSet1\videos)";
//const std::string VIDEO_PATH = VIDEO_DIR + "\\01c71072-718028b8.mov";
