...
/**
 * @class HSM
 * @brief Interface for HSM and HSM_GRPC_Client.
 */
class HSM_Interface {
public:
    virtual ~HSM_Interface() = default;
     ...
     */
    virtual HSM_STATUS create_key_and_get_id(
        const Ident &myId,
        KeyId &keyId,
     ...
     * @return Status of the operation as HSM_STATUS.
     */
    virtual HSM_STATUS signMessage(
        const std::vector<u_int8_t> &message,
